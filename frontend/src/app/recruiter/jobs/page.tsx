    ...
    <div>
      <div className="mb-8 flex justify-between items-center">
        ...
        <button
          ...
          className="bg-[#2fc16c] text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-[#28a85d] transition-colors"
        >
          Create New Vacancy
        </button>
      </div>
                ...
                <tr key={job.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link
                      ...
                      className="text-[#2fc16c] text-sm font-semibold hover:underline"
                    >
                      View
                    </Link>
                  </td>
